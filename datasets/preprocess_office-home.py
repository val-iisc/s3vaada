...
for d in domains:
    path = "data/Office-Home/OfficeHomeDataset_10072016/" + d + "/"
    ...
    # np.savez("office-home/"+d+"10.npz",
    #          data=data_p, label=label_p)
    # print("Saved {}10.npz. It's length is {}".format(d, len(labels[idx])))
    np.savez("/home/sumukh/office-home/"+d+"65.npz", data=data, label=labels)
    print("Saved {}65.npz. It's length is {}".format(d, len(labels)))
